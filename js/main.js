...
function create() {
 ...
 // function newToOldTileProperties(tileproperties){
 //   const newtileproperties = {}
 //
 //   tileproperties.forEach(tileproperty => {
 //     newtileproperties[tileproperty.id.toString()] = {
 //       collides: tileproperty
 //         .properties
 //         .filter(property => property.name == "collides")[0]
 //         .value
 //     }
 //   })
 //
 //   return newtileproperties;
 // }
